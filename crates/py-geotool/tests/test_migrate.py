...
class TestCoordMigrate:
    ...
    def test_abs(self, origin_x, origin_y, rel_x, rel_y, angle):
        test_x, test_y = geotool.CoordMigrate.abs(
    ...
    def test_origin(self, abs_x, abs_y, rel_x, rel_y, angle):
        test_x, test_y = geotool.CoordMigrate.origin(abs_x=abs_x, abs_y=abs_y, rel_x=rel_x, rel_y=rel_y, angle=angle)
    ...
    def test_rel(self, origin_x, origin_y, abs_x, abs_y, angle):
        test_x, test_y = geotool.CoordMigrate.rel(
            origin_x=origin_x,
            origin_y=origin_y,
            abs_x=abs_x,
            abs_y=abs_y,
