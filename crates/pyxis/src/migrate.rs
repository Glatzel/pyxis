...
/// let m=pyxis_algorithm::rotate_matrix_2d(150.0f64.to_radians());
/// let result=pyxis_algorithm::migrate::rel_2d(10.0, 20.0, 2.0, -1.0,&m);
...
/// use float_cmp::assert_approx_eq;
/// let m=pyxis_algorithm::rotate_matrix_2d(150.0f64.to_radians());
/// let result=pyxis_algorithm::migrate::abs_2d(10.0, 20.0, 2.0, -1.0, &m);
...
/// use float_cmp::assert_approx_eq;
/// let m=pyxis_algorithm::rotate_matrix_2d(150.0f64.to_radians());
/// let result=pyxis_algorithm::migrate::origin_2d(10.0, 20.0, 2.0, -1.0, &m);
