...
pub const PROJ_VERSION_MINOR: u32 = 9;
...
pub type PJ_LOG_LEVEL = libc::c_uint;
...
#[doc = " Opaque structure for PROJ for a file handle. Implementations might cast it\n to their structure/class of choice."]
#[repr(C)]
#[derive(Debug)]
...
pub type PROJ_OPEN_ACCESS = libc::c_uint;
...
#[doc = " Opaque structure for PROJ for a network handle. Implementations might cast\n it to their structure/class of choice."]
#[repr(C)]
#[derive(Debug)]
...
pub type PJ_GUESSED_WKT_DIALECT = libc::c_uint;
...
pub type PJ_CATEGORY = libc::c_uint;
...
pub type PROJ_CRS_EXTENT_USE = libc::c_uint;
...
pub type PROJ_SPATIAL_CRITERION = libc::c_uint;
...
pub type PROJ_INTERMEDIATE_CRS_USE = libc::c_uint;
...
pub type PJ_COORDINATE_SYSTEM_TYPE = libc::c_uint;
...
unsafe extern "C" {
    pub fn proj_crs_is_dynamic(ctx: *mut PJ_CONTEXT, crs: *const PJ) -> libc::c_int;
}
unsafe extern "C" {
...
pub type PJ_UNIT_TYPE = libc::c_uint;
...
pub type PJ_CARTESIAN_CS_2D_TYPE = libc::c_uint;
...
pub type PJ_ELLIPSOIDAL_CS_2D_TYPE = libc::c_uint;
...
pub type PJ_ELLIPSOIDAL_CS_3D_TYPE = libc::c_uint;
...
unsafe extern "C" {
    pub fn proj_create_linear_affine_parametric_conversion(
        ctx: *mut PJ_CONTEXT,
        name: *const libc::c_char,
        A0: f64,
        A0_unit_name: *const libc::c_char,
        A0_unit_conv_factor: f64,
        A1: f64,
        A1_unit_name: *const libc::c_char,
        A1_unit_conv_factor: f64,
        A2: f64,
        A2_unit_name: *const libc::c_char,
        A2_unit_conv_factor: f64,
        B0: f64,
        B0_unit_name: *const libc::c_char,
        B0_unit_conv_factor: f64,
        B1: f64,
        B1_unit_name: *const libc::c_char,
        B1_unit_conv_factor: f64,
        B2: f64,
        B2_unit_name: *const libc::c_char,
        B2_unit_conv_factor: f64,
    ) -> *mut PJ;
}
unsafe extern "C" {
    pub fn proj_create_linear_3D_affine_parametric_conversion(
        ctx: *mut PJ_CONTEXT,
        name: *const libc::c_char,
        A0: f64,
        A0_unit_name: *const libc::c_char,
        ...
        A2_unit_conv_factor: f64,
        A3: f64,
        A3_unit_name: *const libc::c_char,
        ...
        B2_unit_conv_factor: f64,
        B3: f64,
        B3_unit_name: *const libc::c_char,
        B3_unit_conv_factor: f64,
        C0: f64,
        C0_unit_name: *const libc::c_char,
        C0_unit_conv_factor: f64,
        C1: f64,
        C1_unit_name: *const libc::c_char,
        C1_unit_conv_factor: f64,
        C2: f64,
        C2_unit_name: *const libc::c_char,
        C2_unit_conv_factor: f64,
        C3: f64,
        C3_unit_name: *const libc::c_char,
...
unsafe extern "C" {
    pub fn proj_create_derived_projected_crs(
        ctx: *mut PJ_CONTEXT,
        crs_name: *const libc::c_char,
        base_proj_crs: *const PJ,
        deriving_conversion: *const PJ,
        coordinate_system: *const PJ,
    ) -> *mut PJ;
}
unsafe extern "C" {
    pub fn proj_crs_add_horizontal_derived_conversion(
        ctx: *mut PJ_CONTEXT,
        crs_name: *const libc::c_char,
        base_crs: *const PJ,
        deriving_conversion: *const PJ,
