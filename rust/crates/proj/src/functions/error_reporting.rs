...
impl crate::Pj {
    ...
    pub(crate) fn errno(&self) -> PjErrorCode {
    ...
    pub(crate) fn _errno_set(&self, err: &PjErrorCode) -> &Self {
    ...
    pub(crate) fn _errno_reset(&self) -> PjErrorCode {
    ...
    pub(crate) fn _errno_restore(&self, err: &PjErrorCode) -> &Self {
    ...
    pub(crate) fn errno_string(&self, err: &PjErrorCode) -> String {
