...
impl Context {
    ...
    pub fn create_conversion_transverse_mercator(&self) { todo!() }
    ///# References
    ///
    ...
    pub fn create_conversion_gauss_schreiber_transverse_mercator(&self) { todo!() }
    ///# References
    ///
    ...
    pub fn create_conversion_transverse_mercator_south_oriented(&self) { todo!() }
    ///# References
    ///
