...
impl Proj {
    ...
    pub fn alter_name(&self, name: &str) -> Result<Proj, ProjErrorKind> {
        let ptr = unsafe {
    ...
    pub fn alter_id(&self, auth_name: &str, code: &str) -> Result<Proj, ProjErrorKind> {
        let ptr = unsafe {
    ...
    pub fn crs_alter_geodetic_crs(&self, new_geod_crs: &Proj) -> Result<Proj, ProjErrorKind> {
        let ptr = unsafe {
    ...
    pub fn crs_promote_to_3d(&self, crs_3d_name: Option<&str>) -> Result<Proj, ProjErrorKind> {
    ...
    pub fn crs_demote_to_2d(&self, crs_2d_name: Option<&str>) -> Result<Proj, ProjErrorKind> {
        let mut owned = OwnedCStrings::with_capacity(1);
        let ptr = unsafe {
...
mod test_proj_advanced {
    ...
    use super::*;
    #[test]
    fn test_alter_name() -> Result<(), ProjErrorKind> {
    ...
    #[test]
    fn test_alter_id() -> Result<(), ProjErrorKind> {
        let ctx = crate::new_test_ctx()?;
        let pj: Proj = ctx.create_geographic_crs(
            Some("WGS 84"),
            Some("World Geodetic System 1984"),
    ...
    #[test]
    fn test_crs_alter_geodetic_crs() -> Result<(), ProjErrorKind> {
        let ctx = crate::new_test_ctx()?;
        let pj = ctx
            .clone()
    ...
    #[test]
    fn test_crs_alter_cs_angular_unit() -> Result<(), ProjErrorKind> {
        let ctx = crate::new_test_ctx()?;
    ...
    #[test]
    fn test_crs_alter_cs_linear_unit() -> Result<(), ProjErrorKind> {
        let ctx = crate::new_test_ctx()?;
    ...
    #[test]
    fn test_crs_alter_parameters_linear_unit() -> Result<(), ProjErrorKind> {
        let ctx = crate::new_test_ctx()?;
        let pj = ctx.create_from_database("EPSG", "32631", Category::Crs, false)?;
    ...
    #[test]
    fn test_crs_promote_to_3d() -> Result<(), ProjErrorKind> {
        let ctx = crate::new_test_ctx()?;
        let pj = ctx.create("EPSG:4326")?;
    ...
    #[test]
    fn test_crs_create_projected_3d_crs_from_2d() -> Result<(), ProjErrorKind> {
        let ctx = crate::new_test_ctx()?;
        let proj_crs = ctx
            .clone()
            .create_from_database("EPSG", "32631", Category::Crs, false)?;
    ...
    #[test]
    fn test_crs_demote_to_2d() -> Result<(), ProjErrorKind> {
        let ctx = crate::new_test_ctx()?;
    ...
    #[test]
    fn test_convert_conversion_to_other_method() -> Result<(), ProjErrorKind> {
        let ctx = crate::new_test_ctx()?;
    ...
    #[test]
    fn test_crs_create_bound_crs_to_wgs84() -> Result<(), ProjErrorKind> {
        let ctx = crate::new_test_ctx()?;
        let pj = ctx.create_from_database("EPSG", "32631", Category::Crs, false)?;
