...
impl crate::Context {
    ...
    pub fn set_enable_network(&self, enabled: bool) -> Result<&Self, ProjErrorKind> {
        let result =
    ...
    pub fn is_network_enabled(&self) -> Result<bool, ProjErrorKind> {
    ...
    pub fn set_url_endpoint(&self, url: &str) -> Result<&Self, ProjErrorKind> {
        unsafe {
    ...
    pub fn get_url_endpoint(&self) -> Result<String, ProjErrorKind> {
    ...
    pub fn get_user_writable_directory(&self, create: bool) -> Result<PathBuf, ProjErrorKind> {
        let result = unsafe {
    ...
    pub fn grid_cache_set_enable(&self, enabled: bool) -> Result<&Self, ProjErrorKind> {
    ...
    pub fn grid_cache_set_filename(&self, fullname: &str) -> Result<&Self, ProjErrorKind> {
        unsafe {
    ...
    pub fn grid_cache_set_max_size(&self, max_size_mbyte: u16) -> Result<&Self, ProjErrorKind> {
    ...
    pub fn grid_cache_set_ttl(&self, ttl_seconds: u16) -> Result<&Self, ProjErrorKind> {
    ...
    pub fn grid_cache_clear(&self) -> Result<&Self, ProjErrorKind> {
