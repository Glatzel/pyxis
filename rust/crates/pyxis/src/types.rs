...
impl ConstEllipsoid<f32> for f32 {
    fn cgcs2000() -> &'static Ellipsoid<f32> { &GRS1980_F32 }
    fn iag1975() -> &'static Ellipsoid<f32> { &IAG1975_F32 }
    fn grs1980() -> &'static Ellipsoid<f32> { &GRS1980_F32 }
    fn krasovsky1940() -> &'static Ellipsoid<f32> { &KRASOVSKY1940_F32 }
    fn wgs84() -> &'static Ellipsoid<f32> { &WGS84_F32 }
}
//f64
...
impl ConstEllipsoid<f64> for f64 {
    fn cgcs2000() -> &'static Ellipsoid<f64> { &GRS1980_F64 }
    fn iag1975() -> &'static Ellipsoid<f64> { &IAG1975_F64 }
    fn grs1980() -> &'static Ellipsoid<f64> { &GRS1980_F64 }
    fn krasovsky1940() -> &'static Ellipsoid<f64> { &KRASOVSKY1940_F64 }
    fn wgs84() -> &'static Ellipsoid<f64> { &WGS84_F64 }
}
