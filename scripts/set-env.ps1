...
if ($IsWindows) {
    ...
    Copy-Item $ROOT/.pixi/envs/default/Library/share/proj/proj.db $ROOT/src/rust/crates/pyxis-cli/src/proj.db
}
if ($IsLinux) {
    # copy proj.db to cli src
    pixi install
    Copy-Item $ROOT/.pixi/envs/default/share/proj/proj.db $ROOT/src/rust/crates/pyxis-cli/src/proj.db
}
